...
// The blog-post metadata assertions below should not depend on whether
  ...
  getPostBySlug: (slug: string) =>
    slug === 'fixture-post'
      ? {
          ...
          title: 'Fixture Post',
          date: '2026-01-01',
          description: 'A fixture post used to test page metadata.',
...
import { metadata as astrophotographyMetadata } from '../astrophotography/page';
...
describe('page metadata', () => {
  ...
  it.each([
    ...
    ['books', booksMetadata, `${SITE_URL}/books/`],
    [
      'astrophotography',
      astrophotographyMetadata,
      `${SITE_URL}/astrophotography/`,
    ],
  ...
  it.each([
    ...
    ['books', booksMetadata],
    ['astrophotography', astrophotographyMetadata],
