# Anass ELHOUD — Personal Site

[![Build Status](https://img.shields.io/github/actions/workflow/status/anasselhoud/anasselhoud.github.io/node.js.yml?branch=main)](https://github.com/anasselhoud/anasselhoud.github.io/actions)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](./LICENSE)
[![GitHub Stars](https://img.shields.io/github/stars/anasselhoud/anasselhoud.github.io?style=social)](https://github.com/anasselhoud/anasselhoud.github.io/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/anasselhoud/anasselhoud.github.io?style=social)](https://github.com/anasselhoud/anasselhoud.github.io/network/members)

The source for [aelhoud.com](https://aelhoud.com): a deliberately bespoke
...
**[Visit the live site →](https://aelhoud.com)**
...
- A résumé whose complete content remains available to print.
...
```bash
gh repo fork anasselhoud/anasselhoud.github.io --clone
cd anasselhoud.github.io
npm ci
npm run dev
```
