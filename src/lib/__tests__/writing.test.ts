...
// Merging/sorting behavior should not depend on whether content/writing/ has
// any published posts at any given time — that coupling is what broke this
// suite when the last owned post was removed. A fixture post decouples it.
vi.mock('@/lib/posts', () => ({
  getAllPosts: () => [
    {
      slug: 'fixture-post',
      title: 'Fixture Post',
      date: '2026-01-01',
      description: 'A fixture post used to test writing item merging.',
    },
  ],
}));
